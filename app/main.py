...
APP_NAME = "Agent Proposal Scoring API"
APP_SLUG = "proposalscoreapi"
DEFAULT_BASE_URL = "https://agent-proposal-scoring-api.up.railway.app"
...
FOLLOWUP_FROM_EMAIL = os.getenv("FOLLOWUP_FROM_EMAIL", "Agent Proposal Scoring API <joseph@dataweaveai.com>").strip()
...
STARTER_PRICE_LABEL = os.getenv("STARTER_PRICE_LABEL", "$89/mo").strip()
...
STARTER_MONTHLY_COST_CAP_USD = float(os.getenv("STARTER_MONTHLY_COST_CAP_USD", "17.8"))
